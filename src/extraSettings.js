...
let setFruits = {
  ...
  startFruits: reverseLevelUp ? [10, 10, 9, 8, 8, 7] : [0, 0, 1, 2, 2, 3], //[0, 0, 1, 2, 2, 3]  [10, 10, 10,10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10]
  randomFunction: () => {
...
let adLink = 'https://ydy.youzu.com/';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成绯灵吧！';
